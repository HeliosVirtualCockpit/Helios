...
namespace GadrocsWorkshop.Helios.Gauges.C130J.ElevatorTrim
{
    ...
    public class ElevatorTrim : CompositeBaseGauge
    {
            ...
            : base("ElevatorTrim", new Size(300, 300))
        {
            ...
            _position = new HeliosValue(this, BindingValue.Empty, "Elevator Trim Gauge", "position", "Current position of the elevator trim.", "-10 to +30 degrees", BindingValueUnits.Degrees);
            _position.Execute += new HeliosActionHandler(Position_Execute);
            Actions.Add(_position);

            _needleCalibration = new CalibrationPointCollectionDouble(-10d, -30d, 30d, 90d){
        ...
        void CreateInputBindings()
        {
            ...
            {
                { "Instruments.Elevator Trim Needle.changed", "Elevator Trim Gauge.set.position" },
            };
