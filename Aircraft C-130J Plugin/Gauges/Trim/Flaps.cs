...
namespace GadrocsWorkshop.Helios.Gauges.C130J.Flaps
{
    ...
    [HeliosControl("Helios.C130J.Flaps", "Flaps Gauge", "C-130J Hercules", typeof(GaugeRenderer), HeliosControlFlags.None)]
    public class Flaps : CompositeBaseGauge
    {
            ...
            : base("Flaps", new Size(300, 300))
        {
            ...
            Components.Add(new GaugeImage("{C-130J}/Gauges/Trim/Herc-Flaps-Bezel.xaml", new Rect(0d, 0d, 300d, 300d)));
