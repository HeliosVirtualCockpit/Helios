...
namespace GadrocsWorkshop.Helios.Gauges.C130J.ADI
{
    ...
    public class ADI : BaseGauge
    {
            ...
            : base("ADI", new Size(350, 350))
        {
            ...
            _rollNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-Roll-Arrows.xaml", new Point(175d, 175d), new Size(62.786d * scale, 308.846d * scale), new Point(62.786d * scale / 2d, 308.846d * scale / 2d));
            Components.Add(_rollNeedle);

            Components.Add(new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Wings.xaml", new Rect(50d, 168d, 352.917d * scale, 87.492d * scale)));

            _ilsCalibration = new CalibrationPointCollectionDouble(-1d, -116d, 1d, 116d);

            _ilsHorizontalNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-Horizontal-GS.xaml", new Point(175d, 175d), new Size(69.167d * scale, 292.250d * scale), new Point(66.001d * scale, (204.921d * scale) - 14d));
            _ilsHorizontalNeedle.HorizontalOffset = _ilsCalibration.Interpolate(-1d);
            Components.Add(_ilsHorizontalNeedle);

            _ilsVerticalNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-Vertical-GS.xaml", new Point(175d, 175d), new Size(299.778d * scale, 7.500d * scale), new Point(182.515d * scale, (3.750d * scale) / 2d));
            _ilsVerticalNeedle.VerticalOffset = _ilsCalibration.Interpolate(-1d);
            Components.Add(_ilsVerticalNeedle);

            Components.Add(new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Inner_Ring.xaml", new Rect(0d, 0d, 315.000d, 333.000d)));

            Components.Add(new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Outer_Ring.xaml", new Rect(0d, 0d, 347.000d, 340.500d)));

            _ilsScaleNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-GS-Pointer.xaml", new Point(35d, 174d), new Size(15.479d, 14.221d), new Point(1d, 14.221d / 2d));
            Components.Add(_ilsScaleNeedle);

            _gsFlagImage = new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Flags-GS.xaml", new Rect(61d, 112d, 22.500d * scale, 44.500d * scale), 1 , -30);
            _gsFlagImage.IsHidden = true;
            Components.Add(_gsFlagImage);

            _locFlagImage = new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Flags-LOC.xaml", new Rect(273d, 93d, 22.500d * scale, 61.500d * scale), 1, 30);
            _locFlagImage.IsHidden = true;
            Components.Add(_locFlagImage);

            _auxFlagImage = new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Flags-AUX.xaml", new Rect(273d, 187d, 22.500d * scale, 61.500d * scale), 1, -30);
            _auxFlagImage.IsHidden = true;
            Components.Add(_auxFlagImage);

            _offFlagImage = new GaugeImage("{C-130J}/Gauges/ADI/Viper-ADI-Flags-OFF.xaml", new Rect(57d, 187d, 22.500d * scale, 61.500d * scale), 1, 30);
            ...
            _slipBallNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-Slip-Ball.xaml", new Point(175d, 308d), new Size(12d, 12d), new Point(6d, 6d));
            Components.Add(_slipBallNeedle);

            Components.Add(new GaugeImage("{C-130J}/Gauges/ADI/adi_bezel.png", new Rect(0d, 0d, 350d, 350d)));

            _turnCalibration = new CalibrationPointCollectionDouble(-1d, -38.5d, 1d, 38.5d);
            _turnNeedle = new GaugeNeedle("{C-130J}/Gauges/ADI/Viper-ADI-Turn-Rate-Pointer.xaml", new Point(175d, 328d), new Size(24.5d, 12.5d), new Point(12.25d, 0d));
