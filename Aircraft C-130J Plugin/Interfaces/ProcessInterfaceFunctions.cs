...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.C130J
{
    internal static class ProcessInterfaceFunctions
    {
        ...
        private static void AddInstrumentFunctions()
        {
            ...
            _functionList.Add(new ScaledNetworkValue(_baseUDPInterface, "130", new CalibrationPointCollectionDouble(0d, -1.0d, 1d, 1.0d), "Instruments", "Slip Ball", "-1 to 1", BindingValueUnits.Numeric, "%.2f", false));
            ...
            WriteCsFunction(@"AddFunction(new ScaledNetworkValue(_baseUDPInterface, ""130"", new CalibrationPointCollectionDouble(0d, -1.0d, 1d, 1.0d), ""Instruments"", ""Slip Ball"", ""-1 to 1"", BindingValueUnits.Numeric, ""%.2f"", false));");
