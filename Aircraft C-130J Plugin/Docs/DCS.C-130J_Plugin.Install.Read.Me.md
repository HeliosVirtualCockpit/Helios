# **Helios Virtual Cockpit 1.6 Plugin: DCS C-130J Hercules**

   
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS C-130J Hercules from the Aircraft Simulation Company.  
