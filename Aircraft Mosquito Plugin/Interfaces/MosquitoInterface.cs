...
// #define DEV
            ...
            AddFunction(new ScaledNetworkValue(this, "242", new CalibrationPointCollectionDouble(-1.0d, -100d, 1.0d, 100.0d), "Flight Controls", "Stick Pitch", "-100 to 100", "Percentage of Travel", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "243", new CalibrationPointCollectionDouble(-1.0d, -100d, 1.0d, 100.0d), "Flight Controls", "Stick Bank", "-100 to 100", "Percentage of Travel", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "249", new CalibrationPointCollectionDouble(-1.0d, -100d, 1.0d, 100.0d), "Flight Controls", "Rudder Yaw", "-100 to 100", "Percentage of Travel", BindingValueUnits.Numeric, "%.4f", true));

            #region Flight Instruments
            // AN5730 Repeater Compass
            AddFunction(new ScaledNetworkValue(this, "47", new CalibrationPointCollectionDouble(0d, 0d, 1d, 360d), "Flight Instruments", "Repeater Compass Heading", "0 to 360", "Degrees", BindingValueUnits.Degrees, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "48", new CalibrationPointCollectionDouble(0d, 0d, 1d, 360d), "Flight Instruments", "Repeater Compass Course", "0 to 360", "Degrees", BindingValueUnits.Degrees, "%.4f", true));

            AddFunction(new ScaledNetworkValue(this, "68", new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d), "Flight Instruments", "Altimeter 100's", "0 to 10", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "69", new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d), "Flight Instruments", "Altimeter 1000's", "0 to 10", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "70", new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d), "Flight Instruments", "Altimeter 10000's", "0 to 10", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "71", new CalibrationPointCollectionDouble(0d, 800d, 1d, 1050d), "Flight Instruments", "Air Pressure", "800 to 1050", "milliBar", BindingValueUnits.Millibar, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "67", new CalibrationPointCollectionDouble(-1d, -4000d, 1d, 4000d), "Flight Instruments", "Vertical Velocity", "-4000 to 4000", "Feet per Minute", BindingValueUnits.FeetPerMinute, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "64", new CalibrationPointCollectionDouble(0d, 0d, 0.5d, 500d), "Flight Instruments", "Airspeed", "0 to 500", "Knots", BindingValueUnits.Knots, "%.4f", true));

            AddFunction(new ScaledNetworkValue(this, "65", new CalibrationPointCollectionDouble(-1d, -180d, 1d, 180d), "Flight Instruments", "Artificial Horizon Bank", "-180 to 180", "Degrees", BindingValueUnits.Degrees, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "66", new CalibrationPointCollectionDouble(-1d, -45d, 1d, 45d), "Flight Instruments", "Artificial Horizon Pitch", "-45 to 45", "Degrees", BindingValueUnits.Degrees, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "73", new CalibrationPointCollectionDouble(0d, 0d, 1d, 360d), "Flight Instruments", "DI", "0 to 360", "Degrees", BindingValueUnits.Degrees, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "75", new CalibrationPointCollectionDouble(-1d, -1d, 1d, 1d), "Flight Instruments", "Side Slip", "-1 to 1", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "76", new CalibrationPointCollectionDouble(-1d, -85.94d, 1d, 85.94d), "Flight Instruments", "Turn", "-85.94 to 85.94", "Degrees", BindingValueUnits.Degrees, "%.4f", true));
            ...
            AddFunction(new ScaledNetworkValue(this, "53", new CalibrationPointCollectionDouble(0d, 0d, 1d, 1000d), "Engine Instruments", "Tacho (Starboard) 100's", "0 to 1000", "Number", BindingValueUnits.Numeric, "%.4f", true));
            {
                ...
                AddFunction(new ScaledNetworkValue(this, "54", scale, "Engine Instruments", "Boost Gauge (Port)", "-7 to 25", "Number", BindingValueUnits.Numeric, "%.4f", true));
                AddFunction(new ScaledNetworkValue(this, "55", scale, "Engine Instruments", "Boost Gauge (Starboard)", "-7 to 25", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }


            AddFunction(new ScaledNetworkValue(this, "56", new CalibrationPointCollectionDouble(-1d, -1d, 1d, 120d), "Engine Instruments", "Oil Temperature (Port)", "-1 to 120", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "57", new CalibrationPointCollectionDouble(-1d, -1d, 1d, 120d), "Engine Instruments", "Oil Temperature (Starboard)", "-1 to 120", "Number", BindingValueUnits.Numeric, "%.4f", true));
            ...
            AddFunction(new ScaledNetworkValue(this, "59", new CalibrationPointCollectionDouble(0d, 0d, 1d, 150d), "Engine Instruments", "Oil Pressure (Starboard)", "0 to 150", "Number", BindingValueUnits.Numeric, "%.4f", true));
            {
                ...
                AddFunction(new ScaledNetworkValue(this, "61", scale, "Engine Instruments", "Radiator Temperature (Starboard)", "39 to 140", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "92", scale, "Fuel Instruments", "Fuel Gauge (Inner Port)", "-1 to 160", "Number", BindingValueUnits.Numeric, "%.4f", true));
                AddFunction(new ScaledNetworkValue(this, "93", scale, "Fuel Instruments", "Fuel Gauge (Inner Starboard)", "-1 to 160", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "96", scale, "Fuel Instruments", "Fuel Gauge (Outer Port)", "-1 to 70", "Number", BindingValueUnits.Numeric, "%.4f", true));
                AddFunction(new ScaledNetworkValue(this, "97", scale, "Fuel Instruments", "Fuel Gauge (Outer Starboard)", "-1 to 70", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "94", scale, "Fuel Instruments", "Fuel Gauge (Center)", "-1 to 60", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "95", scale, "Fuel Instruments", "Fuel Gauge (Long Range)", "-1 to 70", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }

            #endregion Engine Instruments
            #region Systematic Instruments
            AddFunction(new ScaledNetworkValue(this, "82", new CalibrationPointCollectionDouble(0d, 0d, 1d, 10000d), "Systematic Instruments", "Oxygen Delivery (Port)", "0 to 10,000", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "155", new CalibrationPointCollectionDouble(0d, 0d, 1d, 10000d), "Systematic Instruments", "Oxygen Delivery (Starboard)", "0 to 10,000", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "83", new CalibrationPointCollectionDouble(0d, 0d, 1d, 1d), "Systematic Instruments", "Oxygen Supply (Port)", "0 to 1", "Number", BindingValueUnits.Numeric, "%.4f"));
            AddFunction(new ScaledNetworkValue(this, "156", new CalibrationPointCollectionDouble(0d, 0d, 1d, 1d), "Systematic Instruments", "Oxygen Supply (Starboard)", "0 to 1", "Number", BindingValueUnits.Numeric, "%.4f"));

            AddFunction(new ScaledNetworkValue(this, "81", new CalibrationPointCollectionDouble(0d, 0d, 0.7d, 70d), "Systematic Instruments", "Flaps", "0 to 70", "Number", BindingValueUnits.Numeric, "%.4f", true));

            AddFunction(new ScaledNetworkValue(this, "85", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 220d), "Systematic Instruments", "Pneumatic Pressure", "0 to 220", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "86", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 130d), "Systematic Instruments", "Wheel Brake Gauge (Left)", "0 to 130", "Number", BindingValueUnits.Numeric, "%.4f", true));
            AddFunction(new ScaledNetworkValue(this, "87", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 130d), "Systematic Instruments", "Wheel Brake Gauge (Right)", "0 to 130", "Number", BindingValueUnits.Numeric, "%.4f", true));
            ...
            AddFunction(new ScaledNetworkValue(this, "103", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 40d), "Systematic Instruments", "Volt Meter", "0 to 40", "Number", BindingValueUnits.Numeric, "%.4f", true));
            ...
            #region Radio Equipment
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "207", scale, "T.1154", "C2", "5.2 to 10.4", "Number", BindingValueUnits.Numeric, "%.4f", true));
                AddFunction(new ScaledNetworkValue(this, "208", scale, "T.1154", "C15", "5.2 to 10.4", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "206", scale, "T.1154", "C4", "2.9 to 5.7", "Number", BindingValueUnits.Numeric, "%.4f", true));
                AddFunction(new ScaledNetworkValue(this, "209", scale, "T.1154", "C16", "2.9 to 5.7", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "205", scale, "T.1154", "C17", "180 to 520", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }
            AddFunction(new ScaledNetworkValue(this, "104", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 0.3d), "T.1154", "M1", "0 to 0.3", "Number", BindingValueUnits.Numeric, "%.4f", true));
            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "105", scale, "T.1154", "M2", "0 to 0.35", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }

            {
                ...
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "106", scale, "T.1154", "M3 HF Aerial Feed", "0 to 0.4", "Number", BindingValueUnits.Numeric, "%.4f", true));
            }

            AddFunction(new ScaledNetworkValue(this, "232", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 1d), "R.1155", "Tuner", "0 to 1", "Number", BindingValueUnits.Numeric, "%.4f"));
            AddFunction(new ScaledNetworkValue(this, "239", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 1d), "R.1155", "Tuning Cathode", "0 to 1", "Number", BindingValueUnits.Numeric, "%.4f"));
            AddFunction(new ScaledNetworkValue(this, "228", new CalibrationPointCollectionDouble(0d, 0d, 1.0d, 1d), "R.1155", "Tuning Anode", "0 to 1", "Number", BindingValueUnits.Numeric, "%.4f"));
            {
                double[] output = new double[] { -1.0, 0.0, 100.0 };
                double[] input = new double[] { -1.0, 0.0, 1.0 };
                CalibrationPointCollectionDouble scale = new CalibrationPointCollectionDouble(input[0], output[0], input[input.Count() - 1], output[output.Count() - 1]);
                for (int ii = 1; ii < input.Count() - 2; ii++) scale.Add(new CalibrationPointDouble(input[ii], output[ii]));
                AddFunction(new ScaledNetworkValue(this, "88", scale, "R.1155", "Direction Finder (Left)", "-1 to 100", "Number", BindingValueUnits.Numeric, "%.4f"));
                AddFunction(new ScaledNetworkValue(this, "89", scale, "R.1155", "Direction Finder (Right)", "-1 to 100", "Number", BindingValueUnits.Numeric, "%.4f"));
            }
