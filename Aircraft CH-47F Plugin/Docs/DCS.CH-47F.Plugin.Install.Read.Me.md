# **Helios Virtual Cockpit 1.6 Plugin: DCS CH-47F Chinook**

   
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS CH-47F Chinook from Eagle Dynamics.  
