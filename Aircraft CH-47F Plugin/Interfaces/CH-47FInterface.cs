...
//#pragma warning restore IDE1006 // Naming Standard issues
            ...
            : base(name, "CH-47Fbl1", "pack://application:,,,/CH-47F;component/Interfaces/ExportFunctions.lua")
        {
            ...
            AddFunction(new Switch(this, devices.MFD_COPILOT_OUTBOARD.ToString("d"), "794", SwitchPositions.Create(3, 0.0d, 0.5d, Commands.Button.Button_33.ToString("d"), new string[] { "Off", "NVG", "Norm" }, "%0.1f"), "MFD (Copilot Left)", "Power", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.MFD_COPILOT_INBOARD.ToString("d"), "830", SwitchPositions.Create(3, 0.0d, 0.5d, Commands.Button.Button_33.ToString("d"), new string[] { "Off", "NVG", "Norm" }, "%0.1f"), "MFD (Copilot Right)", "Power", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.MFD_CENTER.ToString("d"), "866", SwitchPositions.Create(3, 0.0d, 0.5d, Commands.Button.Button_33.ToString("d"), new string[] { "Off", "NVG", "Norm" }, "%0.1f"), "MFD (Center)", "Power", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.MFD_PILOT_INBOARD.ToString("d"), "902", SwitchPositions.Create(3, 0.0d, 0.5d, Commands.Button.Button_33.ToString("d"), new string[] { "Off", "NVG", "Norm" }, "%0.1f"), "MFD (Pilot Left)", "Power", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.MFD_PILOT_OUTBOARD.ToString("d"), "938", SwitchPositions.Create(3, 0.0d, 0.5d, Commands.Button.Button_33.ToString("d"), new string[] { "Off", "NVG", "Norm" }, "%0.1f"), "MFD (Pilot Right)", "Power", "%0.1f"));
