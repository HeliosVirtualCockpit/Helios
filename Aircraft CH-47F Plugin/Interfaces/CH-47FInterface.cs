...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.CH47F
{
    ...
    public class CH47FInterface : DCSInterface
    {
            ...
            : base(name, "CH-47Fbl1", "pack://application:,,,/CH-47F;component/Interfaces/ExportFunctions.lua")
        {
            ...
            AddFunction(new ScaledNetworkValue(this, "1229", 20d, "ARC186 Radio", "Frequency Selector 1st Value", "Value of the 1st digit drum", "0.0 to 1.0", BindingValueUnits.Numeric, "%.2f"));
            AddFunction(new ScaledNetworkValue(this, "1230", 10d, "ARC186 Radio", "Frequency Selector 2nd Value", "Value of the 2nd digit drum", "0.0 to 1.0", BindingValueUnits.Numeric, "%.1f"));
            AddFunction(new ScaledNetworkValue(this, "1231", 10d, "ARC186 Radio", "Frequency Selector 3rd Value", "Value of the 3rd digit drum", "0.0 to 1.0", BindingValueUnits.Numeric, "%.1f"));
            AddFunction(new ScaledNetworkValue(this, "1232", 100d, "ARC186 Radio", "Frequency Selector 4th Value", "Value of the 4th digit drum", "0.0 to 1.0", BindingValueUnits.Numeric, "%.2f"));
