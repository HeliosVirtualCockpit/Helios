...
//#pragma warning restore IDE1006 // Naming Standard issues
            ...
            : base(name, "CH-47Fbl1", "pack://application:,,,/CH-47F;component/Interfaces/ExportFunctions.lua")
        {
            ...
            AddFunction(new FlagValue(this, "540", "OVERHEAD CONSOLE", "TW Jump Indicator Red", ""));
            AddFunction(new FlagValue(this, "539", "OVERHEAD CONSOLE", "TW Jump Indicator Green", ""));
            ...
            AddFunction(new FlagValue(this, "563", "OVERHEAD CONSOLE", "EP APU READY Indicator", ""));
            AddFunction(new FlagValue(this, "562", "OVERHEAD CONSOLE", "EP UTIL PRESSURE Indicator", ""));
