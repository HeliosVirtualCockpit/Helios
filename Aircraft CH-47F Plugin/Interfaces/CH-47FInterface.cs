...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.CH47F
{
    ...
    public class CH47FInterface : DCSInterface
    {
            ...
            : base(name, "CH-47Fbl1", "pack://application:,,,/CH-47F;component/Interfaces/ExportFunctions.lua")
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_3.ToString("d"), $"{startingArgs[0, i]}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R1 FM1 Knob"));
                AddFunction(Switch.CreateThreeWaySwitch(this, devices.GRIPS.ToString("d"), Commands.Button.Button_1.ToString("d"), $"{startingArgs[0, i] +1 }", "1", "Up", "0", "Middle", "-1", "Down", $"Interphone ICS{i + 1}", "R1 FM1 Pull Switch", "%1d"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_8.ToString("d"), $"{startingArgs[0, i] + 2}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R2 UHF Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_13.ToString("d"), $"{startingArgs[0, i] + 4}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R3 VHF Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_18.ToString("d"), $"{startingArgs[0, i] + 6}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R4 HF  Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_23.ToString("d"), $"{startingArgs[0, i] + 8}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R5 FM2 Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_28.ToString("d"), $"{startingArgs[0, i] + 10}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R6 Spare Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_33.ToString("d"), $"{startingArgs[0, i] + 12}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "R7 RWR Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_38.ToString("d"), $"{startingArgs[0, i] + 14}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "N1 VOR/ILS Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_43.ToString("d"), $"{startingArgs[0, i] + 16}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "N2 TACAN Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_48.ToString("d"), $"{startingArgs[0, i] + 18}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "N3 ADF Knob"));
                AddFunction(new Axis(this, $"{startingArgs[1, i]}", Commands.Button.Button_53.ToString("d"), $"{startingArgs[0, i] + 20}", 0.1d, 0d, 1d, $"Interphone ICS{i + 1}", "N4 MB/CWS Knob"));
            ...
            //AddFunction(Switch.CreateToggleSwitch(this, devices.CANTED_CONSOLE.ToString("d"), Commands.Button.Button_1.ToString("d"), "731", "0.0", "Pulled", "1.0", "Norm", "Canted Console", "Main Engine 1 Fire Switch", "%.1f"));
            AddFunction(new PushButton(this, devices.CANTED_CONSOLE.ToString("d"), Commands.Button.Button_1.ToString("d"), "731", "Canted Console", "Main Engine 1 Fire Switch", "%.1f"));
            ...
            AddFunction(Switch.CreateToggleSwitch(this, devices.CANTED_CONSOLE.ToString("d"), Commands.Button.Button_5.ToString("d"), "735", "0.0", "Pulled", "1.0", "Norm", "Canted Console", "Main Engine 2 Fire Switch", "%.1f"));
            ...
            AddFunction(new Axis(this, devices.CANTED_CONSOLE.ToString("d"), Commands.Button.Button_73.ToString("d"), "1332", 0.1d, 0.0d, 1.0d, "Canted Console", "RWR Brightness Knob"));  // elements["RWR_BRIL_KNOB"] =        axis_limited({0, 1}, _("Cockpit.CH47.RWR.dimmer"),       devices.CANTED_CONSOLE, device_commands.Button_73, 1332)
            AddFunction(new PushButton(this, devices.CENTRAL_CONSOLE.ToString("d"), Commands.Button.Button_100.ToString("d"), "741", "Center Console", "Main Parking Brake", "%.1f"));  // elements["MAIN_PARKING_BRAKE"] = button({0}, _("Cockpit.CH47.MAIN.PARKING_LV"), devices.CENTRAL_CONSOLE, device_commands.Button_100, 741, {{SOUND_SW13_PUSH, SOUND_SW13_PULL}})
            ...
            AddFunction(new AbsoluteEncoder(this, devices.ARC_186.ToString("d"), Commands.Button.Button_9.ToString("d"), Commands.Button.Button_10.ToString("d"), "1225", 0.1d, 0.125d, 0.775d, "ARC186 Radio", "Frequency Selector 1st Digit", true, "%.3f"));
            AddFunction(new AbsoluteEncoder(this, devices.ARC_186.ToString("d"), Commands.Button.Button_11.ToString("d"), Commands.Button.Button_12.ToString("d"), "1226", 0.1d, 0.0d, 1.0d, "ARC186 Radio", "Frequency Selector 2nd Digit", true, "%.3f"));
            AddFunction(new AbsoluteEncoder(this, devices.ARC_186.ToString("d"), Commands.Button.Button_13.ToString("d"), Commands.Button.Button_14.ToString("d"), "1227", 0.1d, 0.0d, 1.0d, "ARC186 Radio", "Frequency Selector 3rd Digit", true, "%.3f"));
            AddFunction(new AbsoluteEncoder(this, devices.ARC_186.ToString("d"), Commands.Button.Button_15.ToString("d"), Commands.Button.Button_16.ToString("d"), "1228", 0.25d, 0.0d, 1.0d, "ARC186 Radio", "Frequency Selector 4th Digit", true, "%.3f"));
            AddFunction(new ScaledNetworkValue(this, "1229", 2d, "ARC186 Radio", "Frequency Selector 1st Value", "Value of the 1st digit drum", "0 to 1 in steps of 0.25", BindingValueUnits.Numeric));
            AddFunction(new ScaledNetworkValue(this, "1230", 1d, "ARC186 Radio", "Frequency Selector 2nd Value", "Value of the 2nd digit drum", "0 to 0.1", BindingValueUnits.Numeric));
            AddFunction(new ScaledNetworkValue(this, "1231", 1d, "ARC186 Radio", "Frequency Selector 3rd Value", "Value of the 3rd digit drum", "0 to 0.1", BindingValueUnits.Numeric));
            AddFunction(new ScaledNetworkValue(this, "1232", 1d, "ARC186 Radio", "Frequency Selector 4th Value", "Value of the 4th digit drum", "0 to 0.15", BindingValueUnits.Numeric));
            ...
            /// TODO:  Not convinced this 1320 arg is correct!  Check it out.
