...
namespace GadrocsWorkshop.Helios.Gauges.FA18C.Instruments
{
    ...
    [HeliosControl("Helios.FA18C.Instruments.O2Gauge2", "Liquid Oxygen - Night", "F/A-18C Gauges - Night", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class O2Gauge2 : BaseGauge
    {
            ...
            : base("O2 Gauge", new Size(300, 300))
        {
            ...
            Components.Add(new GaugeImage("{FA-18C}/Gauges/LOx/N_LOx_Faceplate.png", new Rect(0d, 0d, 300d, 300d)));

            _needleCalibration = new CalibrationPointCollectionDouble(0d, -90d, 1d, 90d);
            _needle = new GaugeNeedle("{FA-18C}/Gauges/Common/N_needle_a.xaml", new Point(150d, 150d), new Size(30, 128), new Point(15, 113), -90d);
