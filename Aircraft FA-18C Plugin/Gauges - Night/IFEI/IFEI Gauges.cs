...
namespace GadrocsWorkshop.Helios.Gauges.FA18C
{
    ...
    [HeliosControl("Helios.FA18C.IFEIGauges2", "IFEI Needles & Flags - Night", "F/A-18C Gauges - Night", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class IFEI_Gauges2 : BaseGauge
    {
        ...
        private Color _textColor = Color.FromArgb(0xff,50, 170, 50);
            ...
            : base("IFEI_Gauges", new Size(779, 702))
        {
            ...
            _gibackground = new GaugeImage(_imageLocation + "N IFEI.png", new Rect(0d, 0d, 779d, 702d));
