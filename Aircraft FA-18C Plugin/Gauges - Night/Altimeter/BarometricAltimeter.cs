...
namespace GadrocsWorkshop.Helios.Gauges.FA18C.Instruments
{
    ...
    [HeliosControl("Helios.FA18C.Instruments.BAltimeter2", "Altimeter - Night", "F/A-18C Gauges - Night", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class BAltimeter2 : BaseGauge
    {
            ...
            : base("Barometric Altimeter", new Size(376, 376))
        {
            ...
            _tensDrum = new GaugeDrumCounter("{FA-18C}/Gauges/Altimeter/N_alt_drum_tape.xaml", new Point(73d, 129d), "#", new Size(10d, 15d), new Size(31d, 38d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(71d, 144d, 31d, 38d));
            Components.Add(_tensDrum);

            _drum = new GaugeDrumCounter("{FA-18C}/Gauges/Common/N_drum_tape.xaml", new Point(123d, 128d), "#%00", new Size(10d, 15d), new Size(31d, 38d));
            _drum.Clip = new RectangleGeometry(new Rect(123d, 130d, 31d, 38d));
            Components.Add(_drum);

            _airPressureDrum = new GaugeDrumCounter("{FA-18C}/Gauges/Common/N_drum_tape.xaml", new Point(135d, 276d), "###%", new Size(10d, 15d), new Size(24d, 32d));
            ...
            Components.Add(new GaugeImage("{FA-18C}/Gauges/Altimeter/N_Altimeter_Faceplate.png", new Rect(0d, 0d, 376d, 376d)));

            _needleCalibration = new CalibrationPointCollectionDouble(0d, 0d, 1000d, 360d);
            _needle = new GaugeNeedle("{FA-18C}/Gauges/Altimeter/N_altimeter_needle.xaml", new Point(188d, 188d), new Size(16d, 160d), new Point(8d, 160d));
