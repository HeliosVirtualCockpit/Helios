...
namespace GadrocsWorkshop.Helios.Gauges.FA18C.Instruments
{
    ...
    [HeliosControl("Helios.FA18C.Instruments2", "RADAR Altimeter - Night", "F/A-18C Gauges - Night", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class RAltimeter2 : BaseGauge
    {
            ...
            : base("RADAR Altimeter", new Size(420, 420))
        {
            ...
            Components.Add(new GaugeImage("{FA-18C}/Images/N Radar Altimeter Blank.png", new Rect(179d, 288d, 56d, 22d)));
            ...
            _giOff = new GaugeImage("{FA-18C}/Images/N Radar Altimeter Off Flag.png", new Rect(179d, 287d, 56d, 24d));
            ...
            Components.Add(new GaugeImage("{FA-18C}/Gauges/Altimeter/N_RADAR_Altimeter_Faceplate.png", new Rect(0d, 0d, 420d, 420d)));
            ...
            _needle = new GaugeNeedle("{FA-18C}/Gauges/Altimeter/N_altimeter_needle.xaml", new Point(210d, 210d), new Size(16d, 250d), new Point(8d, 200d),0d);
            Components.Add(_needle);
            _minimum_needle = new GaugeNeedle("{FA-18C}/Gauges/Altimeter/N_RADAR_Altimeter_Min_Needle.xaml", new Point(210d, 210d), new Size(46d, 205d), new Point(23d, 205d),0d);
            Components.Add(_minimum_needle);

            Components.Add(new GaugeImage("{FA-18C}/Gauges/Altimeter/N_RADAR_Altimeter_Cover.png", new Rect(94d, 11d, 89d, 88d)));  // this is the needle cover
