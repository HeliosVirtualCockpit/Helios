...
namespace GadrocsWorkshop.Helios.Gauges.FA18C
{
    ...
    [HeliosControl("Helios.FA18C.UFC2", "Up Front Controller - Night", "F/A-18C - Night", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class UFC_FA18C2 : FA18CDevice
    {
        ...
        {
            get { return "{FA-18C}/Images/N UFC Faceplate.png"; }
        }
        ...
        private void AddEncoder(string name, Point posn, Size size, string interfaceElementName)
        {
            AddEncoder(
                ...
                size: size,
                posn: posn,
                knobImage: "{FA-18C}/Images/N UFC Rotator_U.png",
                stepValue: 0.1,
                rotationStep: 5,
                interfaceDeviceName: _interfaceDeviceName,
                interfaceElementName: interfaceElementName,
        ...
        private void AddButton(string name, double x, double y, Size size, string interfaceElementName)
        {
            ...
            AddButton(
                ...
                posn: pos,
                size: size,
                image: "{FA-18C}/Images/N UFC Button Up " + name + ".png",
                pushedImage: "{FA-18C}/Images/N UFC Button Dn " + name + ".png",
                buttonText: "",
                interfaceDeviceName: _interfaceDeviceName,
                interfaceElementName: interfaceElementName,
                fromCenter: false
