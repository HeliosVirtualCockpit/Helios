...
namespace GadrocsWorkshop.Helios.Gauges.FA18C.ADI
{
    ...
    [HeliosControl("Helios.FA18C.ADI.V1", "ADI (V1)", "F/A-18C Gauges", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class ADI_V1 : AltImageGauge
    {
        ...
        public ADI_V1()
            : base("ADI (V1)", new Size(350, 350), "Alt")
        {
