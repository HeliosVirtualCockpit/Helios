# **Helios Virtual Cockpit 1.6 Plugin: DCS F/A-18C Hornet**

   
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS F/A-18C Hornet from Eagle Dynamics.  
