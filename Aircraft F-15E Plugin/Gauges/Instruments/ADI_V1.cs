...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.ADI
{
    ...
    [HeliosControl("Helios.F15E.Instruments.ADI.V1", "ADI V1", "F-15E Strike Eagle", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class ADIGauge_V1 : BaseGauge
    {
