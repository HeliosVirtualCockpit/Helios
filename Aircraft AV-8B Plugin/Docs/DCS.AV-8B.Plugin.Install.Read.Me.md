# **Helios Virtual Cockpit 1.6 Plugin: DCS AV-8B N/A**

   
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS AV-8B N/A from RazBam.  
