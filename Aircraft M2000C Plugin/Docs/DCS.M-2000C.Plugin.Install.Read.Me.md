# **Helios Virtual Cockpit 1.6 Plugin: DCS Mirage 2000C**
  
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS Mirage 2000C from RazBam.  
