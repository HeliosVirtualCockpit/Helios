...
namespace GadrocsWorkshop.Helios.Gauges.M2000C.ADI.Backup
{
    ...
    [HeliosControl("Helios.M2000C.ADI.Backup.Gauge.V1", "Backup ADI Gauge (V1)", "M-2000C", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class BackupADIGauge_V1 : BaseGauge
    {
        ...
        public BackupADIGauge_V1(string name, Size size, string device)
            : base(name, size)
        {
