...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.M2000C
{
    ...
    public class M2000CInterface : DCSInterface
    {
            ...
            : base("DCS M2000C", "M-2000C", "pack://application:,,,/M2000C;component/Interfaces/ExportFunctions.lua")
        {
            ...
            AddFunction(new ADIBallRotation(this, "2050", new CalibrationPointCollectionDouble(-0.9d, -90d, 0.9d, 90d), new CalibrationPointCollectionDouble(0d, 0d, 1d, 360d), new CalibrationPointCollectionDouble(-1d, -180d, 1d, 180d)));
