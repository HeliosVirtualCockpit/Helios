...
namespace GadrocsWorkshop.Helios.Gauges.A_10.ADI
{
    ...
    [HeliosControl("Helios.A10.ADI.V1", "ADI (V1)", "A-10 Gauges", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class ADI_V1 : BaseGauge
    {
        ...
        public ADI_V1()
            : base("ADI (V1)", new Size(350, 350))
        {
            Point center = new Point(174d, 163d);

            _pitchCalibration = new CalibrationPointCollectionDouble(-360d, -1066d, 360d, 1066d);
            _ball = new GaugeNeedle("{Helios}/Gauges/A-10/ADI/V1/adi_ball.xaml", center, new Size(225d, 1350d), new Point(112.5d, 677d));
            _ball.Clip = new EllipseGeometry(center, 113d, 113d);
            Components.Add(_ball);

            Components.Add(new GaugeImage("{Helios}/Gauges/A-10/ADI/V1/adi_inner_ring.xaml", new Rect(0d, 0d, 350d, 350d)));

            _slipBallCalibration = new CalibrationPointCollectionDouble(-1d, -26d, 1d, 26d);
            _slipBallNeedle = new GaugeNeedle("{Helios}/Gauges/A-10/ADI/V1/adi_slip_ball.xaml", new Point(174d, 297d), new Size(10d, 10d), new Point(5d, 5d));
            Components.Add(_slipBallNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/A-10/ADI/V1/adi_guides.xaml", new Rect(0d, 0d, 350d, 350d)));
            ...
            _pitchSteeringNeedle = new GaugeNeedle("{Helios}/Gauges/A-10/ADI/V1/adi_pitch_steering_bar.xaml", new Point(0d, 163d), new Size(252d, 6d), new Point(0d, 3d));
            ...
            _bankSteeringNeedle = new GaugeNeedle("{Helios}/Gauges/A-10/ADI/V1/adi_bank_steering_bar.xaml", new Point(175d, 0d), new Size(24d, 239d), new Point(23d, 0d));
            ...
            _gsIndicatorNeedle = new GaugeNeedle("{Helios}/Gauges/A-10/ADI/V1/adi_gs_indicator.xaml", new Point(44d, 163d), new Size(14d, 12d), new Point(1d, 6d));
            Components.Add(_gsIndicatorNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/A-10/ADI/V1/adi_outer_ring.xaml", new Rect(0d, 0d, 350d, 350d)));
