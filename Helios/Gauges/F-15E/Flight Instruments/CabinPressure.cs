...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.CabinPressure
{
    ...
    public class CabinPressure : BaseGauge
    {
        ...
        public CabinPressure(string name, Size size)
            : base(name, size)
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/F-15E/Flight Instruments/CabinPressureDial.xaml", new Rect(32d, 38d, 300d, 300d)));
            ...
            _pressure = new HeliosValue(this, new BindingValue(0d), "", "cabin pressure", "Cabin pressure of the aircraft.", "(0 to 50,000)", BindingValueUnits.Feet);
