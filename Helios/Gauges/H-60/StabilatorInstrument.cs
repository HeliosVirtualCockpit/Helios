...
namespace GadrocsWorkshop.Helios.Gauges.H60.Instruments
{
    ...
    [HeliosControl("Helios.H60.Stabilator.Indicator", "Stabilator Position Instrument", "H-60", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class StabInstrument : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Images/H-60/StabScale.xaml", new Rect(0d, 0d, 276d, 233d)));
            ...
            _needle = new GaugeNeedle("{Helios}/Images/H-60/StabNeedle.xaml", new Point(77d, 81d), new Size(171d, 28d), new Point(14d, 14d), 0d);
            ...
            _offFlagNeedle = new GaugeNeedle("{Helios}/Images/H-60/StabOffFlag.xaml", new Point(77d, 81d), new Size(25d, 59d), new Point(0d, -80d), -20d);
            ...
            Components.Add(new GaugeImage("{Helios}/Images/H-60/StabSurface.xaml", new Rect(0d, 0d, 276d, 233d)));
