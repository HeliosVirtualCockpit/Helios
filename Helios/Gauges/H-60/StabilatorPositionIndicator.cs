...
namespace GadrocsWorkshop.Helios.Gauges.H60.Instruments
{
    ...
    [HeliosControl("Helios.H60.Stabilator", "Stabilator Position Indicator", "H-60", typeof(BackgroundImageRenderer),HeliosControlFlags.None)]
    public class StabilatorPositionIndicator : CompositeVisualWithBackgroundImage
    {
            ...
            : base("Stabilator Position Indicator", new Size(276, 233))
        {
            ...
            SupportedInterfaceNames = new[] { "DCS H-60 (MH-60R Seahawk)", "DCS H-60 (UH-60L Blackhawk)" };  // only needed if gauge supports a SoftInterface
