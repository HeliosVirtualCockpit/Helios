...
namespace GadrocsWorkshop.Helios.Gauges.H60.Instruments
{
    ...
    [HeliosControl("Helios.H60.IAS.Indicator", "Indicated Air Speed Instrument", "H-60", typeof(GaugeRenderer), HeliosControlFlags.None)]
    public class IASInstrument : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Images/H-60/IAS.xaml", new Rect(0d, 4d, 420d, 420d)));
            ...
            _needle = new GaugeNeedle("{Helios}/Images/H-60/IASNeedle.xaml", new Point(210d, 210d), new Size(48d, 230d), new Point(24d, 129d), 0d);
