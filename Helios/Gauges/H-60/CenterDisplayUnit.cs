...
namespace GadrocsWorkshop.Helios.Gauges.H60.Instruments.CDU
{
    ...
    [HeliosControl("Helios.H60.CenterDisplayUnit", "Center Display Unit", "H-60", typeof(BackgroundImageRenderer),HeliosControlFlags.None)]
    public class CenterDisplayUnit : CompositeVisualWithBackgroundImage
    {
            ...
            : base("Center Display Unit", new Size(1250,712))
        {
            ...
            AddBarGauge("Transmission Pressure Gauge", new Point(319, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30TransmissionPressure.xaml", _interfaceDeviceName, "Transmission Pressure");
            AddBarGauge("Oil Temp 1", new Point(420, 145), new Size(40, 522), 29d, "{Helios}/Images/H-60/SegmentBarDisplay29OilTemp.xaml", _interfaceDeviceName, "Engine 1 Oil Temperature");
            AddBarGauge("Oil Temp 2", new Point(540, 145), new Size(40, 522), 29d, "{Helios}/Images/H-60/SegmentBarDisplay29OilTemp.xaml", _interfaceDeviceName, "Engine 2 Oil Temperature");
            AddBarGauge("Oil Pressure 1", new Point(619, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30OilPressure.xaml", _interfaceDeviceName, "Engine 1 Oil Pressure");
            AddBarGauge("Oil Pressure 2", new Point(740, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30OilPressure.xaml", _interfaceDeviceName, "Engine 2 Oil Pressure");
            AddBarGauge("Engine 1 TGT Temp", new Point(840, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30TGT.xaml", _interfaceDeviceName, "Engine 1 TGT");
            AddBarGauge("Engine 2 TGT Temp", new Point(960, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30TGT.xaml", _interfaceDeviceName, "Engine 2 TGT");
            AddBarGauge("Engine 1 Ng Speed", new Point(1060, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30Ng.xaml", _interfaceDeviceName, "Engine 1 Ng");
            AddBarGauge("Engine 2 Ng Speed", new Point(1180, 128), new Size(40, 540), 30d, "{Helios}/Images/H-60/SegmentBarDisplay30Ng.xaml", _interfaceDeviceName, "Engine 2 Ng");
        }
        ...
        {
            get { return "{Helios}/Images/H-60/CenterDisplayUnitBackground.xaml"; }
        }
