...
namespace GadrocsWorkshop.Helios.Gauges.UH60L.Instruments.DisplayUnit
{
    ...
    [HeliosControl("Helios.UH60L.FlyerDisplayUnit.Pilot", "Display Unit (Pilot)", "H-60", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    public class PilotDisplayUnit : H60.Instruments.DisplayUnit.FlyerDisplayUnit
    { 
        public PilotDisplayUnit()
            : base(H60.FLYER.Pilot)
        {
