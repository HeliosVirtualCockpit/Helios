...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    public class FourWayToggleSwitchRenderer : HeliosVisualRenderer
    {
        ...
        private ImageSource _imageCenter;
        private ImageSource _imageCenterIndicatorOn;
        private Rect _imageRect;

        protected override void OnRender(DrawingContext drawingContext)
        {
            FourWayToggleSwitch toggleSwitch = Visual as FourWayToggleSwitch;
            if (toggleSwitch != null)
            {
                switch (toggleSwitch.SwitchPosition)
                {
                    ...
                    case FourWayToggleSwitchPosition.Center:
                        if (toggleSwitch.HasIndicator && toggleSwitch.IndicatorOn && _imageCenterIndicatorOn != null)
                        {
                            DrawImage(drawingContext, _imageCenterIndicatorOn, _imageRect);
                        }
                        else
                        {
                            DrawImage(drawingContext, _imageCenter, _imageRect);
                        }
                        break;
                }
            }
        ...
        protected override void OnRefresh()
        {
            ...
            if (toggleSwitch != null)
            {
                ...
                _imageCenter = refreshCapableImage.LoadImage(toggleSwitch.PositionCenterImage, loadOptions);
                _imageCenterIndicatorOn = refreshCapableImage.LoadImage(toggleSwitch.PositionCenterIndicatorOnImage, loadOptions);
            }
            else
            {
                _imageOne = null;
