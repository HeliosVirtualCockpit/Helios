...
{
    public class EnumToNegativeIntConverter : IValueConverter
    {
        ...
        public EnumToNegativeIntConverter()
        {
        }

        public EnumToNegativeIntConverter(Type type)
        {
            Type = type;
        }
        ...
        {
            //EnsureLoaded();
            Logger.Debug("attempting to convert back from {Value} to Negative Int", value, targetType);
