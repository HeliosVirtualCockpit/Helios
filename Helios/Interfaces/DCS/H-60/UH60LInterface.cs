...
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "018", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.EFM_commands.extPwrSwitch.ToString("d"),UH60LCommands.EFM_commands.extPwrSwitch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", UH60LCommands.EFM_commands.extPwrSwitch2.ToString("d"),UH60LCommands.EFM_commands.extPwrSwitch2.ToString("d"),"0.0","0.0")}, "Electric system", "External Power Switch, ON/OFF/RESET", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "019", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.EFM_commands.apuGenSwitch.ToString("d"),UH60LCommands.EFM_commands.apuGenSwitch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", UH60LCommands.EFM_commands.apuGenSwitch2.ToString("d"),UH60LCommands.EFM_commands.apuGenSwitch2.ToString("d"),"0.0","0.0")}, "Electric system", "APU GEN Switch, ON/OFF/TEST", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "020", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.EFM_commands.gen1Switch.ToString("d"),UH60LCommands.EFM_commands.gen1Switch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", UH60LCommands.EFM_commands.gen1Switch2.ToString("d"),UH60LCommands.EFM_commands.gen1Switch2.ToString("d"),"0.0","0.0")}, "Electric system", "GEN 1 Switch, ON/OFF/TEST", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "021", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.EFM_commands.gen2Switch.ToString("d"),UH60LCommands.EFM_commands.gen2Switch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", UH60LCommands.EFM_commands.gen2Switch2.ToString("d"),UH60LCommands.EFM_commands.gen2Switch2.ToString("d"),"0.0","0.0")}, "Electric system", "GEN 2 Switch, ON/OFF/TEST", "%0.1f"));
...
AddFunction(new Switch(this, devices.AVS7.ToString("d"), "1100", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.setAVS7Power.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.setAVS7Power.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.setAVS7Power.ToString("d"))}, "AN/AVS-7 PANEL", "AN/AVS-7 OFF/ON/ADJUST", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "252", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.posLightIntensity.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.posLightIntensity.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.posLightIntensity.ToString("d"))}, "Lighting", "Position Lights DIM/OFF/BRT", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "254", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.antiLightGrp.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.antiLightGrp.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.antiLightGrp.ToString("d"))}, "Lighting", "Anticollision Lights UPPER/BOTH/LOWER", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "255", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.antiLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.antiLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.antiLightMode.ToString("d"))}, "Lighting", "Anticollision Lights DAY/OFF/NIGHT", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "257", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.cabinLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.cabinLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.cabinLightMode.ToString("d"))}, "Lighting", "Cabin Lights BLUE/OFF/WHITE", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "269", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.cockpitLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.cockpitLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.cockpitLightMode.ToString("d"))}, "Lighting", "Cockpit Lights BLUE/OFF/WHITE", "%0.1f"));
            #endregion Lighting
            #region AN/APR-39
AddFunction(new Switch(this, devices.APR39.ToString("d"), "270", new SwitchPosition[] {new SwitchPosition("1.0", "AN", UH60LCommands.device_commands.apr39Power.ToString("d")),new SwitchPosition("0.0", "APR-39 Power ON/OFF", UH60LCommands.device_commands.apr39Power.ToString("d"))}, "AN/APR-39", "AN/APR-39 Power ON/OFF", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARC186.ToString("d"), "419", SwitchPositions.Create(3, 0d, 0.5d, UH60LCommands.device_commands.arc186ModeSelector.ToString("d"), "Posn", "%0.1f"), "ARC-186 VHF", "AN/ARC-186 Mode Selector", "%0.1f"));
            ...
            #region AFMS
AddFunction(new Switch(this, devices.AFMS.ToString("d"), "460", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.afmcpXferMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.afmcpXferMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.afmcpXferMode.ToString("d"))}, "AFMS", "Aux Fuel Transfer Mode MAN/OFF/AUTO", "%0.1f"));
AddFunction(new Switch(this, devices.AFMS.ToString("d"), "461", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.afmcpManXfer.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.afmcpManXfer.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.afmcpManXfer.ToString("d"))}, "AFMS", "Aux Fuel Manual Transfer RIGHT/BOTH/LEFT", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARN149.ToString("d"), "621", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.arn149ToneTest.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.arn149ToneTest.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.arn149ToneTest.ToString("d"))}, "AN/ARN-149", "AN/ARN-149 TONE/OFF/TEST", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARN147.ToString("d"), "653", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", UH60LCommands.device_commands.arn147Power.ToString("d")),new SwitchPosition("0.0", "Posn 2", UH60LCommands.device_commands.arn147Power.ToString("d")),new SwitchPosition("1.0", "Posn 3", UH60LCommands.device_commands.arn147Power.ToString("d"))}, "AN/ARN-147", "AN/ARN-147 Power Selector OFF/ON/TEST", "%0.1f"));
