...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.H60.MH60R
{
    ...
    public class MH60RInterface : H60Interface
    {
            ...
            : base(name, "MH-60R", "pack://application:,,,/Helios;component/Interfaces/DCS/H-60/ExportFunctionsRomeo.lua")
        {
            ...
            H60InterfaceCreator ic = new H60InterfaceCreator();
...
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "018", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.EFM_commands.extPwrSwitch.ToString("d"),MH60RCommands.EFM_commands.extPwrSwitch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", MH60RCommands.EFM_commands.extPwrSwitch2.ToString("d"),MH60RCommands.EFM_commands.extPwrSwitch2.ToString("d"),"0.0","0.0")}, "Electric system", "External Power Switch, ON/OFF/RESET", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "019", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.EFM_commands.apuGenSwitch.ToString("d"),MH60RCommands.EFM_commands.apuGenSwitch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", MH60RCommands.EFM_commands.apuGenSwitch2.ToString("d"),MH60RCommands.EFM_commands.apuGenSwitch2.ToString("d"),"0.0","0.0")}, "Electric system", "APU GEN Switch, ON/OFF/TEST", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "020", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.EFM_commands.gen1Switch.ToString("d"),MH60RCommands.EFM_commands.gen1Switch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", MH60RCommands.EFM_commands.gen1Switch2.ToString("d"),MH60RCommands.EFM_commands.gen1Switch2.ToString("d"),"0.0","0.0")}, "Electric system", "GEN 1 Switch, ON/OFF/TEST", "%0.1f"));
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "021", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.EFM_commands.gen2Switch.ToString("d"),MH60RCommands.EFM_commands.gen2Switch.ToString("d"),"0.0","0.0"), new SwitchPosition("0.0", "Posn 2", null),new SwitchPosition("1.0", "Posn 3", MH60RCommands.EFM_commands.gen2Switch2.ToString("d"),MH60RCommands.EFM_commands.gen2Switch2.ToString("d"),"0.0","0.0")}, "Electric system", "GEN 2 Switch, ON/OFF/TEST", "%0.1f"));
...
AddFunction(new PushButton(this, devices.AFCS.ToString("d"), MH60RCommands.device_commands.afcsBoost.ToString("d"), "038", "STAB PANEL", "SAS Boost ON/OFF", "%1d"));
            ...
            #region FUEL PUMPS
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "040", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.EFM_commands.fuelPumpL.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.EFM_commands.fuelPumpL.ToString("d"))}, "FUEL PUMPS", "No. 1 Fuel Boost Pump ON/OFF", "%0.1f"));
...
AddFunction(new Switch(this, devices.EFM_HELPER.ToString("d"), "080", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.parkingBrake.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.parkingBrake.ToString("d"))}, "PARKING BRAKE", "Parking Brake ON/OFF", "%0.1f"));
...
AddFunction(new Switch(this, devices.AVS7.ToString("d"), "1100", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.setAVS7Power.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.setAVS7Power.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.setAVS7Power.ToString("d"))}, "AN/AVS-7 PANEL", "AN/AVS-7 OFF/ON/ADJUST", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "252", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.posLightIntensity.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.posLightIntensity.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.posLightIntensity.ToString("d"))}, "Lighting", "Position Lights DIM/OFF/BRT", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "253", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.posLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.posLightMode.ToString("d"))}, "Lighting", "Position Lights STEADY/FLASH", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "254", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.antiLightGrp.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.antiLightGrp.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.antiLightGrp.ToString("d"))}, "Lighting", "Anticollision Lights UPPER/BOTH/LOWER", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "255", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.antiLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.antiLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.antiLightMode.ToString("d"))}, "Lighting", "Anticollision Lights DAY/OFF/NIGHT", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "256", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.navLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.navLightMode.ToString("d"))}, "Lighting", "Nav Lights NORM/IR", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "257", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.cabinLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.cabinLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.cabinLightMode.ToString("d"))}, "Lighting", "Cabin Lights BLUE/OFF/WHITE", "%0.1f"));
...
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "268", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.magCompassLights.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.magCompassLights.ToString("d"))}, "Lighting", "Magnetic Compass Light ON/OFF", "%0.1f"));
AddFunction(new Switch(this, devices.EXTLIGHTS.ToString("d"), "269", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.cockpitLightMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.cockpitLightMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.cockpitLightMode.ToString("d"))}, "Lighting", "Cockpit Lights BLUE/OFF/WHITE", "%0.1f"));
            #endregion Lighting
            #region AN/APR-39
AddFunction(new Switch(this, devices.APR39.ToString("d"), "270", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.apr39Power.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.apr39Power.ToString("d"))}, "AN/APR-39", "AN/APR-39 Power ON/OFF", "%0.1f"));
...
AddFunction(new Switch(this, devices.PLT_ICP.ToString("d"), "408", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.pilotICPToggleVOR.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.pilotICPToggleVOR.ToString("d"))}, "PILOT ICS PANEL", "Pilot ICP RCV VOR/LOC", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARC186.ToString("d"), "419", SwitchPositions.Create(3, 0d, 0.5d, MH60RCommands.device_commands.arc186ModeSelector.ToString("d"), "Posn", "%0.1f"), "ARC-186 VHF", "AN/ARC-186 Mode Selector", "%0.1f"));
            ...
            #region AFMS
AddFunction(new Switch(this, devices.AFMS.ToString("d"), "460", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.afmcpXferMode.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.afmcpXferMode.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.afmcpXferMode.ToString("d"))}, "AFMS", "Aux Fuel Transfer Mode MAN/OFF/AUTO", "%0.1f"));
AddFunction(new Switch(this, devices.AFMS.ToString("d"), "461", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.afmcpManXfer.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.afmcpManXfer.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.afmcpManXfer.ToString("d"))}, "AFMS", "Aux Fuel Manual Transfer RIGHT/BOTH/LEFT", "%0.1f"));
AddFunction(new Switch(this, devices.AFMS.ToString("d"), "462", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.afmcpXferFrom.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.afmcpXferFrom.ToString("d"))}, "AFMS", "Aux Fuel Transfer From OUTBD/INBD", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARN149.ToString("d"), "621", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.arn149ToneTest.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.arn149ToneTest.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.arn149ToneTest.ToString("d"))}, "AN/ARN-149", "AN/ARN-149 TONE/OFF/TEST", "%0.1f"));
...
AddFunction(new Switch(this, devices.ARN147.ToString("d"), "653", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.arn147Power.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.arn147Power.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.arn147Power.ToString("d"))}, "AN/ARN-147", "AN/ARN-147 Power Selector OFF/ON/TEST", "%0.1f"));
...
AddFunction(new Switch(this, devices.WEAPONS.ToString("d"), "2002", new SwitchPosition[] {new SwitchPosition("-1.0", "Posn 1", MH60RCommands.device_commands.setSonarLift.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.setSonarLift.ToString("d")),new SwitchPosition("1.0", "Posn 3", MH60RCommands.device_commands.setSonarLift.ToString("d"))}, "AUX SYSTEM CONTROL PANEL", "Sonar DOWN/STOP/UP", "%0.1f"));
...
AddFunction(new Switch(this, devices.WEAPONS.ToString("d"), "2016", SwitchPositions.Create(8, 0d, 0.1d, MH60RCommands.device_commands.jettStationSel.ToString("d"), "Posn", "%0.1f"), "JETTISON", "Select Stations", "%0.1f"));
            #endregion JETTISON
            #region DEBUG
AddFunction(new Switch(this, devices.DEBUG.ToString("d"), "3000", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.visualisationToggle.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.visualisationToggle.ToString("d"))}, "DEBUG", "Debug Visualisation ON/OFF", "%0.1f"));
...
AddFunction(new FlagValue(this,  mainpanel.freeAirTemp.ToString("d"), "FAT passed directly from FM", "FAT_GAUGE","", "%1d"));
AddFunction(new NetworkValue(this,  mainpanel.IASneedle.ToString("d"), "FAT passed directly from FM", "IAS", "Number representation of a value between 0 and 250", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
...
AddFunction(new FlagValue(this,  mainpanel.ahruIndAln.ToString("d"), "AHRU", "AHRU_IND_ALIGN","", "%1d"));
            #endregion AHRU
            #region MAG COMPASS
AddFunction(new NetworkValue(this,  mainpanel.MagCompassBrg.ToString("d"), "MAG COMPASS", "CURRENT_HDG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.MagCompassBank.ToString("d"), "MAG COMPASS", "MAGCOMPASS_BANK", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.MagCompassPitch.ToString("d"), "MAG COMPASS", "MAGCOMPASS_PITCH", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion MAG COMPASS
            #region PILOT HSI
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICompass.ToString("d"), "PILOT HSI", "PILOT_HSI_COMPASS", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIHdgBug.ToString("d"), "PILOT HSI", "PILOT_HSI_HDGBUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSINo1Bug.ToString("d"), "PILOT HSI", "PILOT_HSI_NO1BUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSINo2Bug.ToString("d"), "PILOT HSI", "PILOT_HSI_NO2BUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICrsBug.ToString("d"), "PILOT HSI", "PILOT_HSI_CRSBUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICrsDev.ToString("d"), "PILOT HSI", "PILOT_HSI_CRSDEV", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIVorArrow.ToString("d"), "PILOT HSI", "PILOT_HSI_VORARROW", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIDistDrum1.ToString("d"), "PILOT HSI", "PILOT_HSI_DISTDRUM1", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIDistDrum2.ToString("d"), "PILOT HSI", "PILOT_HSI_DISTDRUM2", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIDistDrum3.ToString("d"), "PILOT HSI", "PILOT_HSI_DISTDRUM3", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIDistDrum4.ToString("d"), "PILOT HSI", "PILOT_HSI_DISTDRUM4", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICrsDrum1.ToString("d"), "PILOT HSI", "PILOT_HSI_CRSDRUM1", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICrsDrum2.ToString("d"), "PILOT HSI", "PILOT_HSI_CRSDRUM2", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSICrsDrum3.ToString("d"), "PILOT HSI", "PILOT_HSI_CRSDRUM3", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIHdgFlag.ToString("d"), "PILOT HSI", "PILOT_HSI_HDGFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSINavFlag.ToString("d"), "PILOT HSI", "PILOT_HSI_NAVFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotHSIDistFlag.ToString("d"), "PILOT HSI", "PILOT_HSI_DISTFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion PILOT HSI
            #region COPILOT HSI
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICompass.ToString("d"), "COPILOT HSI", "COPILOT_HSI_COMPASS", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIHdgBug.ToString("d"), "COPILOT HSI", "COPILOT_HSI_HDGBUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSINo1Bug.ToString("d"), "COPILOT HSI", "COPILOT_HSI_NO1BUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSINo2Bug.ToString("d"), "COPILOT HSI", "COPILOT_HSI_NO2BUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICrsBug.ToString("d"), "COPILOT HSI", "COPILOT_HSI_CRSBUG", "Number representation of a value between 0 and 360", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICrsDev.ToString("d"), "COPILOT HSI", "COPILOT_HSI_CRSDEV", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIVorArrow.ToString("d"), "COPILOT HSI", "COPILOT_HSI_VORARROW", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIDistDrum1.ToString("d"), "COPILOT HSI", "COPILOT_HSI_DISTDRUM1", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIDistDrum2.ToString("d"), "COPILOT HSI", "COPILOT_HSI_DISTDRUM2", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIDistDrum3.ToString("d"), "COPILOT HSI", "COPILOT_HSI_DISTDRUM3", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIDistDrum4.ToString("d"), "COPILOT HSI", "COPILOT_HSI_DISTDRUM4", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICrsDrum1.ToString("d"), "COPILOT HSI", "COPILOT_HSI_CRSDRUM1", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICrsDrum2.ToString("d"), "COPILOT HSI", "COPILOT_HSI_CRSDRUM2", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSICrsDrum3.ToString("d"), "COPILOT HSI", "COPILOT_HSI_CRSDRUM3", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIHdgFlag.ToString("d"), "COPILOT HSI", "COPILOT_HSI_HDGFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSINavFlag.ToString("d"), "COPILOT HSI", "COPILOT_HSI_NAVFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotHSIDistFlag.ToString("d"), "COPILOT HSI", "COPILOT_HSI_DISTFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion COPILOT HSI
            #region PILOT AN/APN-209 RADAR ALTIMETER
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotAltNeedle.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_NEEDLE", "Number representation of a value between 0 and 1550", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotAltDigit1.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT1", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotAltDigit2.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT2", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotAltDigit3.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT3", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotAltDigit4.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT4", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotLoBug.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_LOBUG", "Number representation of a value between 0 and 1500", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotHiBug.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_HIBUG", "Number representation of a value between 0 and 1500", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotLoLight.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_LOLIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotHiLight.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_HILIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209PilotFlag.ToString("d"), "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion PILOT AN/APN-209 RADAR ALTIMETER
            #region COPILOT AN/APN-209 RADAR ALTIMETER
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotAltNeedle.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_NEEDLE", "Number representation of a value between 0 and 1550", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotAltDigit1.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT1", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotAltDigit2.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT2", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotAltDigit3.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT3", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotAltDigit4.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT4", "Number representation of a value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotLoBug.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_LOBUG", "Number representation of a value between 0 and 1500", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotHiBug.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_HIBUG", "Number representation of a value between 0 and 1500", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotLoLight.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_LOLIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotHiLight.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_HILIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.apn209CopilotFlag.ToString("d"), "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion COPILOT AN/APN-209 RADAR ALTIMETER
            #region LIGHTING 200 - 250
AddFunction(new NetworkValue(this,  mainpanel.PLTInstLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_PLT_INST", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.CPLTInstLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_CPLT_INST", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.NonFltInstLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_NON_FLT_INST", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.UpperConsoleLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_UPPER_CONSOLE", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.LowerConsoleLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_LOWER_CONSOLE", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.LightedSwitches.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_SWITCHES", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltRdrAltLts.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_PLT_RDR_ALT", "Number representation of a value between 0 and 1", "Numeric value between 0.1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltRdrAltLts.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_CPLT_RDR_ALT", "Number representation of a value between 0 and 1", "Numeric value between 0.1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.GlareshieldLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_GLARESHIELD", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.magCompassLights.ToString("d"), "LIGHTING 200 - 250", "LIGHTING_MAGCOMPASS", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
...
AddFunction(new FlagValue(this,  mainpanel.capBrightness.ToString("d"), "CAP & MCP LAMPS", "CAP_BRIGHTNESS","", "%1d"));
...
AddFunction(new FlagValue(this,  mainpanel.capBlank.ToString("d"), "CAP & MCP LAMPS", "DISPLAY_CAP_BLANK","", "%1d"));
            ...
            #region PILOT VSI
AddFunction(new NetworkValue(this,  mainpanel.pltVSIPitch.ToString("d"), "PILOT VSI", "PILOT_VSI_PITCH", "Number representation of a value between -math.rad(90) and math.rad(90)", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIRoll.ToString("d"), "PILOT VSI", "PILOT_VSI_ROLL", "Number representation of a value between -math.pi and math.pi", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSISlip.ToString("d"), "PILOT VSI", "PILOT_VSI_SLIP_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIRollCmdBar.ToString("d"), "PILOT VSI", "PILOT_VSI_ROLL_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIPitchCmdBar.ToString("d"), "PILOT VSI", "PILOT_VSI_PITCH_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSICollectiveCmdBar.ToString("d"), "PILOT VSI", "PILOT_VSI_COLLECTIVE_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSITurnRateIndicator.ToString("d"), "PILOT VSI", "PILOT_VSI_TURN_RATE_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSITrackErrorIndicator.ToString("d"), "PILOT VSI", "PILOT_VSI_TRACK_ERROR_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIGlideSlopeIndicator.ToString("d"), "PILOT VSI", "PILOT_VSI_GLIDE_SLOPE_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSICMDFlag.ToString("d"), "PILOT VSI", "PILOT_VSI_CMD_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIATTFlag.ToString("d"), "PILOT VSI", "PILOT_VSI_ATT_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSINAVFlag.ToString("d"), "PILOT VSI", "PILOT_VSI_NAV_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pltVSIGSFlag.ToString("d"), "PILOT VSI", "PILOT_VSI_GS_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion PILOT VSI
            #region COPILOT VSI
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIPitch.ToString("d"), "COPILOT VSI", "COPILOT_VSI_PITCH", "Number representation of a value between -math.rad(90) and math.rad(90)", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIRoll.ToString("d"), "COPILOT VSI", "COPILOT_VSI_ROLL", "Number representation of a value between -math.pi and math.pi", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSISlip.ToString("d"), "COPILOT VSI", "COPILOT_VSI_SLIP_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADIRollCmdBar.ToString("d"), "COPILOT VSI", "COPILOT_VSI_ROLL_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADIPitchCmdBar.ToString("d"), "COPILOT VSI", "COPILOT_VSI_PITCH_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADICollectiveCmdBar.ToString("d"), "COPILOT VSI", "COPILOT_VSI_COLLECTIVE_CMD_BAR", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADITurnRateIndicator.ToString("d"), "COPILOT VSI", "COPILOT_VSI_TURN_RATE_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADITrackErrorIndicator.ToString("d"), "COPILOT VSI", "COPILOT_VSI_TRACK_ERROR_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADIGlideSlopeIndicator.ToString("d"), "COPILOT VSI", "COPILOT_VSI_GLIDE_SLOPE_IND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADICMDFlag.ToString("d"), "COPILOT VSI", "COPILOT_VSI_CMD_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADIATTFlag.ToString("d"), "COPILOT VSI", "COPILOT_VSI_ATT_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADINAVFlag.ToString("d"), "COPILOT VSI", "COPILOT_VSI_NAV_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.cpltVSIADIGSFlag.ToString("d"), "COPILOT VSI", "COPILOT_VSI_GS_FLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
...
AddFunction(new NetworkValue(this,  mainpanel.pilotVSILtGA.ToString("d"), "PILOT VSI", "pilotVSILtGA", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotVSILtDH.ToString("d"), "PILOT VSI", "PILOT_APN209_LOLIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.pilotVSILtMB.ToString("d"), "PILOT VSI", "pilotVSILtMB", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotVSILtGA.ToString("d"), "COPILOT VSI", "copilotVSILtGA", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotVSILtDH.ToString("d"), "COPILOT VSI", "COPILOT_APN209_LOLIGHT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.copilotVSILtMB.ToString("d"), "COPILOT VSI", "copilotVSILtMB", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.StabInd.ToString("d"), "Stabilator", "STABIND", "Number representation of a value between -1 and 1", "Numeric value between -1 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.StabIndFlag.ToString("d"), "Stabilator", "STABINDFLAG", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.PilotDoor.ToString("d"), "Doors", "DOOR_PLT", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
            #endregion M130 CM System
            #region ARN-147 dials
AddFunction(new NetworkValue(this,  mainpanel.ARN147MHz100s.ToString("d"), "ARN-147 dials", "ARN147_MHZ100S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.ARN147MHz10s.ToString("d"), "ARN-147 dials", "ARN147_MHZ10S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.ARN147MHz1s.ToString("d"), "ARN-147 dials", "ARN147_MHZ1S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.ARN147KHz100s.ToString("d"), "ARN-147 dials", "ARN147_KHZ100S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.ARN147KHz10s.ToString("d"), "ARN-147 dials", "ARN147_KHZ10S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
AddFunction(new NetworkValue(this,  mainpanel.ARN147KHz1s.ToString("d"), "ARN-147 dials", "ARN147_KHZ1S", "Number representation of a value between 0 and 1", "Numeric value between 0 and 1", BindingValueUnits.Numeric, "%0.3f"));
...
AddFunction(new FlagValue(this,  mainpanel.rCargoDoorGlass.ToString("d"), "Doors", "R_CARGO_DOOR_GLASS","", "%1d"));
        ...
        virtual protected void AddFunctions()
        {
        ...
        virtual internal void MakeFunctionsFromDcsModule(IInterfaceCreator ic)
        {
