...
AddFunction(new Switch(this, devices.WEAPONS.ToString("d"), "2022", new SwitchPosition[] {new SwitchPosition("1.0", "Posn 1", MH60RCommands.device_commands.fireTrigger.ToString("d")),new SwitchPosition("0.0", "Posn 2", MH60RCommands.device_commands.fireTrigger.ToString("d"))}, "DEBUG", "fireTriggernone", "%0.1f"));
            ...
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209PilotAltDigit1.ToString("d"), scaleapn209PilotAltDigit1, "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT1", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209PilotAltDigit2 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209PilotAltDigit2.ToString("d"), scaleapn209PilotAltDigit2, "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT2", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209PilotAltDigit3 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209PilotAltDigit3.ToString("d"), scaleapn209PilotAltDigit3, "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT3", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209PilotAltDigit4 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209PilotAltDigit4.ToString("d"), scaleapn209PilotAltDigit4, "PILOT AN/APN-209 RADAR ALTIMETER", "PILOT_APN209_DIGIT4", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            ...
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209CopilotAltDigit1.ToString("d"), scaleapn209CopilotAltDigit1, "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT1", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209CopilotAltDigit2 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209CopilotAltDigit2.ToString("d"), scaleapn209CopilotAltDigit2, "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT2", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209CopilotAltDigit3 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209CopilotAltDigit3.ToString("d"), scaleapn209CopilotAltDigit3, "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT3", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
            CalibrationPointCollectionDouble scaleapn209CopilotAltDigit4 = new CalibrationPointCollectionDouble(0d, 0d, 1d, 10d);
            AddFunction(new ScaledNetworkValue(this, mainpanel.apn209CopilotAltDigit4.ToString("d"), scaleapn209CopilotAltDigit4, "COPILOT AN/APN-209 RADAR ALTIMETER", "COPILOT_APN209_DIGIT4", "value between 0 and 10", "Numeric value between 0 and 1", BindingValueUnits.Feet, "%0.3f"));
