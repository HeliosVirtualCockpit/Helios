...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.F15E
{
    ...
    /// <summary>
    /// Interface for DCS F15E Strike Eagle containing only functions
    /// </summary>
    [HeliosInterface(
...
#pragma warning disable CS0162 // Unreachable code detected
            ...
            AddFunction(new Switch(this, devices.HUDCTRL.ToString("d"), "121", SwitchPositions.Create(3, 0d, 0d, Commands.hudctrl_commands.HUD_REJ_Switch.ToString("d"), "Posn", "%0.3f"), "HUD Control Panel", "HUD Symbology Reject Mode", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.PACS.ToString("d"), "321", SwitchPositions.Create(7, 0d, 0d, Commands.armtctrl_commands.JETT_Selector_Knob.ToString("d"), "Posn", "%0.3f"), "Armament Panel", "Armament Jettison Selector", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "381", SwitchPositions.Create(7, 0d, 0d, Commands.fltinst_commands.fuelqty_totalizer.ToString("d"), "Posn", "%0.3f"), "Fuel Monitor Panel", "Fuel Totalizer Selector", "%0.3f"));
            ...
            #region LEFT MPD
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_01.ToString("d"), "204", "LEFT MPD", "Push Button 1", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_02.ToString("d"), "203", "LEFT MPD", "Push Button 2", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_03.ToString("d"), "202", "LEFT MPD", "Push Button 3", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_04.ToString("d"), "201", "LEFT MPD", "Push Button 4", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_05.ToString("d"), "200", "LEFT MPD", "Push Button 5", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_06.ToString("d"), "219", "LEFT MPD", "Push Button 6", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_07.ToString("d"), "218", "LEFT MPD", "Push Button 7", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_08.ToString("d"), "217", "LEFT MPD", "Push Button 8", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_09.ToString("d"), "216", "LEFT MPD", "Push Button 9", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_10.ToString("d"), "215", "LEFT MPD", "Push Button 10", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_11.ToString("d"), "214", "LEFT MPD", "Push Button 11", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_12.ToString("d"), "213", "LEFT MPD", "Push Button 12", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_13.ToString("d"), "212", "LEFT MPD", "Push Button 13", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_14.ToString("d"), "211", "LEFT MPD", "Push Button 14", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_15.ToString("d"), "210", "LEFT MPD", "Push Button 15", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_16.ToString("d"), "209", "LEFT MPD", "Push Button 16", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_17.ToString("d"), "208", "LEFT MPD", "Push Button 17", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_18.ToString("d"), "207", "LEFT MPD", "Push Button 18", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_19.ToString("d"), "206", "LEFT MPD", "Push Button 19", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FLEFT.ToString("d"), Commands.mfdg_commands.Button_20.ToString("d"), "205", "LEFT MPD", "Push Button 20", "%1d"));
            AddFunction(new Switch(this, devices.MPD_FLEFT.ToString("d"), "221", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0") }, "LEFT MPD", "Power Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.MPD_FLEFT.ToString("d"), "222", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0") }, "LEFT MPD", "Brightness Control", "%0.1f"));
            AddFunction(new Switch(this, devices.MPD_FLEFT.ToString("d"), "223", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0") }, "LEFT MPD", "Contrast Control", "%0.1f"));
            #endregion LEFT MPD
            #region CENTER MPCD
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_01.ToString("d"), "251", "CENTER MPCD", "Push Button 1", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_02.ToString("d"), "250", "CENTER MPCD", "Push Button 2", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_03.ToString("d"), "249", "CENTER MPCD", "Push Button 3", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_04.ToString("d"), "248", "CENTER MPCD", "Push Button 4", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_05.ToString("d"), "247", "CENTER MPCD", "Push Button 5", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_06.ToString("d"), "266", "CENTER MPCD", "Push Button 6", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_07.ToString("d"), "265", "CENTER MPCD", "Push Button 7", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_08.ToString("d"), "264", "CENTER MPCD", "Push Button 8", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_09.ToString("d"), "263", "CENTER MPCD", "Push Button 9", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_10.ToString("d"), "262", "CENTER MPCD", "Push Button 10", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_11.ToString("d"), "261", "CENTER MPCD", "Push Button 11", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_12.ToString("d"), "260", "CENTER MPCD", "Push Button 12", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_13.ToString("d"), "259", "CENTER MPCD", "Push Button 13", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_14.ToString("d"), "258", "CENTER MPCD", "Push Button 14", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_15.ToString("d"), "257", "CENTER MPCD", "Push Button 15", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_16.ToString("d"), "256", "CENTER MPCD", "Push Button 16", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_17.ToString("d"), "255", "CENTER MPCD", "Push Button 17", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_18.ToString("d"), "254", "CENTER MPCD", "Push Button 18", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_19.ToString("d"), "253", "CENTER MPCD", "Push Button 19", "%1d"));
            AddFunction(new PushButton(this, devices.MPCD_FCENTER.ToString("d"), Commands.mfdg_commands.Button_20.ToString("d"), "252", "CENTER MPCD", "Push Button 20", "%1d"));
            AddFunction(new Switch(this, devices.MPCD_FCENTER.ToString("d"), "267", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0") }, "CENTER MPCD", "Power Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.MPCD_FCENTER.ToString("d"), "268", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0") }, "CENTER MPCD", "Brightness Control", "%0.1f"));
            AddFunction(new Switch(this, devices.MPCD_FCENTER.ToString("d"), "269", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0") }, "CENTER MPCD", "Contrast Control", "%0.1f"));
            #endregion CENTER MPCD
            #region RIGHT MFD
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_01.ToString("d"), "228", "RIGHT MFD", "Push Button 1", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_02.ToString("d"), "227", "RIGHT MFD", "Push Button 2", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_03.ToString("d"), "226", "RIGHT MFD", "Push Button 3", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_04.ToString("d"), "225", "RIGHT MFD", "Push Button 4", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_05.ToString("d"), "224", "RIGHT MFD", "Push Button 5", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_06.ToString("d"), "243", "RIGHT MFD", "Push Button 6", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_07.ToString("d"), "242", "RIGHT MFD", "Push Button 7", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_08.ToString("d"), "241", "RIGHT MFD", "Push Button 8", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_09.ToString("d"), "240", "RIGHT MFD", "Push Button 9", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_10.ToString("d"), "239", "RIGHT MFD", "Push Button 10", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_11.ToString("d"), "238", "RIGHT MFD", "Push Button 11", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_12.ToString("d"), "237", "RIGHT MFD", "Push Button 12", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_13.ToString("d"), "236", "RIGHT MFD", "Push Button 13", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_14.ToString("d"), "235", "RIGHT MFD", "Push Button 14", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_15.ToString("d"), "234", "RIGHT MFD", "Push Button 15", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_16.ToString("d"), "233", "RIGHT MFD", "Push Button 16", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_17.ToString("d"), "232", "RIGHT MFD", "Push Button 17", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_18.ToString("d"), "231", "RIGHT MFD", "Push Button 18", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_19.ToString("d"), "230", "RIGHT MFD", "Push Button 19", "%1d"));
            AddFunction(new PushButton(this, devices.MPD_FRIGHT.ToString("d"), Commands.mfdg_commands.Button_20.ToString("d"), "229", "RIGHT MFD", "Push Button 20", "%1d"));
            AddFunction(new Switch(this, devices.MPD_FRIGHT.ToString("d"), "244", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Power.ToString("d"), Commands.mfdg_commands.Switch_Power.ToString("d"), "0.0", "0.0") }, "RIGHT MFD", "Power Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.MPD_FRIGHT.ToString("d"), "245", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_BRT.ToString("d"), Commands.mfdg_commands.Switch_BRT.ToString("d"), "0.0", "0.0") }, "RIGHT MFD", "Brightness Control", "%0.1f"));
            AddFunction(new Switch(this, devices.MPD_FRIGHT.ToString("d"), "246", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0"), new SwitchPosition("0.0", "Middle", null), new SwitchPosition("-1.0", "Posn 3", Commands.mfdg_commands.Switch_Cont.ToString("d"), Commands.mfdg_commands.Switch_Cont.ToString("d"), "0.0", "0.0") }, "RIGHT MFD", "Contrast Control", "%0.1f"));
            #endregion RIGHT MFD
            #region NUC
            ...
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "451", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.nuc_commands.nuc_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.nuc_commands.nuc_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.nuc_commands.nuc_sw.ToString("d")) }, "NUC", "Nuclear Consent Switch", "%0.1f"));
            #endregion NUC
            #region CAS
            AddFunction(new Switch(this, devices.FLCTRL.ToString("d"), "452", SwitchPositions.Create(3, 0d, 0d, Commands.cas_commands.yaw_sw.ToString("d"), "Posn", "%0.3f"), "CAS", "Yaw CAS Switch, when ON (LMB) RESET/(RMB) OFF", "%0.3f"));
            AddFunction(new Switch(this, devices.FLCTRL.ToString("d"), "453", SwitchPositions.Create(3, 0d, 0d, Commands.cas_commands.roll_sw.ToString("d"), "Posn", "%0.3f"), "CAS", "Roll CAS Switch, when ON (LMB) RESET/(RMB) OFF", "%0.3f"));
            AddFunction(new Switch(this, devices.FLCTRL.ToString("d"), "454", SwitchPositions.Create(3, 0d, 0d, Commands.cas_commands.pitch_sw.ToString("d"), "Posn", "%0.3f"), "CAS", "Pitch CAS Switch, when ON (LMB) RESET/(RMB) OFF", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "535", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.misc_commands.left_inlet_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.misc_commands.left_inlet_sw.ToString("d")) }, "MISC", "Left Inlet Ramp Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "536", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.misc_commands.right_inlet_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.misc_commands.right_inlet_sw.ToString("d")) }, "MISC", "Right Inlet Ramp Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.LGS.ToString("d"), "537", SwitchPositions.Create(3, 0d, 0d, Commands.misc_commands.anti_skid_sw.ToString("d"), "Posn", "%0.3f"), "MISC", "Anti Skid Switch", "%0.3f"));
            #endregion MISC
            #region FUEL
            AddFunction(new Switch(this, devices.AFSS.ToString("d"), "527", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.fuelpnl_commands.fueltrnfr_wing_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.fuelpnl_commands.fueltrnfr_wing_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.fuelpnl_commands.fueltrnfr_wing_sw.ToString("d")) }, "FUEL", "Fuel Control: Wing Tanks", "%0.1f"));
            AddFunction(new Switch(this, devices.AFSS.ToString("d"), "528", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.fuelpnl_commands.fueltrnfr_ctr_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.fuelpnl_commands.fueltrnfr_ctr_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.fuelpnl_commands.fueltrnfr_ctr_sw.ToString("d")) }, "FUEL", "Fuel Control: Centerline Tank", "%0.1f"));
            AddFunction(new Switch(this, devices.AFSS.ToString("d"), "529", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.fuelpnl_commands.fueltrnfr_cft_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.fuelpnl_commands.fueltrnfr_cft_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.fuelpnl_commands.fueltrnfr_cft_sw.ToString("d")) }, "FUEL", "Fuel Control: Conformal Tanks", "%0.1f"));
            AddFunction(new Switch(this, devices.AFSS.ToString("d"), "530", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.fuelpnl_commands.fuel_dump_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.fuelpnl_commands.fuel_dump_sw.ToString("d")) }, "FUEL", "Fuel Dump", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.AFSS.ToString("d"), "533", SwitchPositions.Create(3, 0d, 0d, Commands.fuelpnl_commands.fuel_AIR_sw.ToString("d"), "Posn", "%0.3f"), "FUEL", "A/R Slipway", "%0.3f"));
            #endregion FUEL
            ...
            AddFunction(new Axis(this, devices.TEWS.ToString("d"), Commands.volctrl_commands.launch_vol.ToString("d"), "503", 0.1d, 0.0d, 1.0d, "VOL", "Launch Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.ICS.ToString("d"), Commands.volctrl_commands.ics_vol.ToString("d"), "504", 0.1d, 0.0d, 1.0d, "VOL", "ICS Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.PACS.ToString("d"), Commands.volctrl_commands.wpn_vol.ToString("d"), "505", 0.1d, 0.0d, 1.0d, "VOL", "WPN Voume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.ILS.ToString("d"), Commands.volctrl_commands.ils_vol.ToString("d"), "506", 0.1d, 0.0d, 1.0d, "VOL", "ILS Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.TACAN.ToString("d"), Commands.volctrl_commands.tacan_vol.ToString("d"), "507", 0.1d, 0.0d, 1.0d, "VOL", "TACAN Volume", false, "%0.1f"));
            #endregion VOL
            #region MICS
            ...
            AddFunction(new Switch(this, devices.ICS.ToString("d"), "509", SwitchPositions.Create(3, 0d, 0d, Commands.micsctrl_commands.mic_sw.ToString("d"), "Posn", "%0.3f"), "MICS", "MIC Switch", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "513", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.radioctrl_commands.tone_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.radioctrl_commands.tone_sw.ToString("d")) }, "RADIO", "Tone Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "514", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.radioctrl_commands.cypher_txt_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.radioctrl_commands.cypher_txt_sw.ToString("d")) }, "RADIO", "Cypher Text Switch", "%0.1f"));
            #endregion RADIO
            #region IFF
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "515", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.iffctrl_commands.mode_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.iffctrl_commands.mode_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.iffctrl_commands.mode_sw.ToString("d")) }, "IFF", "IFF Mode Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "516", SwitchPositions.Create(3, 0d, 0d, Commands.iffctrl_commands.rec_sw.ToString("d"), "Posn", "%0.3f"), "IFF", "IFF Reply Switch", "%0.3f"));
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "517", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.iffctrl_commands.master_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.iffctrl_commands.master_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.iffctrl_commands.master_sw.ToString("d")) }, "IFF", "IFF Master Switch", "%0.1f"));
            #endregion IFF
            #region EXT LT
            AddFunction(new Switch(this, devices.EXTLT.ToString("d"), "538", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.extlt_commands.ldg_taxi_light_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.extlt_commands.ldg_taxi_light_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.extlt_commands.ldg_taxi_light_sw.ToString("d")) }, "EXT LT", "Landing/Taxi Light Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.EXTLT.ToString("d"), "465", SwitchPositions.Create(7, 0d, 0d, Commands.extlt_commands.formation_lt_knob.ToString("d"), "Posn", "%0.3f"), "EXT LT", "Formation Lights Knob", "%0.3f"));
            AddFunction(new Switch(this, devices.EXTLT.ToString("d"), "466", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.extlt_commands.anticoll_lt_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.extlt_commands.anticoll_lt_sw.ToString("d")) }, "EXT LT", "Anti Collison Light Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.EXTLT.ToString("d"), "467", SwitchPositions.Create(7, 0d, 0d, Commands.extlt_commands.pos_lt_knob.ToString("d"), "Posn", "%0.3f"), "EXT LT", "Position Lights Knob", "%0.3f"));
            AddFunction(new Switch(this, devices.EXTLT.ToString("d"), "468", SwitchPositions.Create(3, 0d, 0d, Commands.extlt_commands.vert_tail_lt_sw.ToString("d"), "Posn", "%0.3f"), "EXT LT", "Tail Flood Lights", "%0.3f"));
            #endregion EXT LT
            #region SENSOR
            AddFunction(new Switch(this, devices.TFR.ToString("d"), "469", SwitchPositions.Create(3, 0d, 0d, Commands.snsrctrl_commands.tf_rdr_sw.ToString("d"), "Posn", "%0.3f"), "SENSOR", "Terrain Follow Radar Switch", "%0.3f"));
            AddFunction(new Switch(this, devices.ADC.ToString("d"), "470", SwitchPositions.Create(3, 0d, 0d, Commands.snsrctrl_commands.rdr_alt_sw.ToString("d"), "Posn", "%0.3f"), "SENSOR", "Radar Altitude Switch", "%0.3f"));
            AddFunction(new Switch(this, devices.AN_APG70.ToString("d"), "471", SwitchPositions.Create(4, 0d, 0d, Commands.snsrctrl_commands.rdr_power_sw.ToString("d"), "Posn", "%0.3f"), "SENSOR", "Radar Mode Selector", "%0.3f"));
            AddFunction(new Switch(this, devices.INS.ToString("d"), "472", SwitchPositions.Create(4, 0d, 0d, Commands.snsrctrl_commands.ins_knob.ToString("d"), "Posn", "%0.3f"), "SENSOR", "INS Knob", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.NAVPOD.ToString("d"), "475", SwitchPositions.Create(3, 0d, 0d, Commands.snsrctrl_commands.nav_flir_sw.ToString("d"), "Posn", "%0.3f"), "SENSOR", "Nav FLIR Switch", "%0.3f"));
            AddFunction(new Switch(this, devices.RDRCTRL_AA.ToString("d"), "476", SwitchPositions.Create(5, 0d, 0d, Commands.snsrctrl_commands.jtids_knob.ToString("d"), "Posn", "%0.3f"), "SENSOR", "JTIDS Knob", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "520", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.iffctrl_commands.iff_ant_sel_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.iffctrl_commands.iff_ant_sel_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.iffctrl_commands.iff_ant_sel_sw.ToString("d")) }, "LEFT BULKHEAD PANEL", "IFF Antenna Select Switch", "%0.1f"));
            ...
            #region OXYGEN
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "551", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.oxyctrl_commands.oxy_emer_norm_test_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.oxyctrl_commands.oxy_emer_norm_test_sw.ToString("d")), new SwitchPosition("-1.0", "Posn 3", Commands.oxyctrl_commands.oxy_emer_norm_test_sw.ToString("d")) }, "OXYGEN", "Oxygen Emergency/Normal/Test Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "552", new SwitchPosition[] { new SwitchPosition("1.0", "", Commands.oxyctrl_commands.oxy_100_norm_sw.ToString("d")), new SwitchPosition("0.0", "Normal Switch", Commands.oxyctrl_commands.oxy_100_norm_sw.ToString("d")) }, "OXYGEN", "Oxygen 100%/Normal Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "553", SwitchPositions.Create(3, 0d, 0d, Commands.oxyctrl_commands.oxy_pbg_on_off_sw.ToString("d"), "Posn", "%0.3f"), "OXYGEN", "Oxygen Supply/Mode Control Switch", "%0.3f"));
            #endregion OXYGEN
            #region ECS
            ...
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "558", SwitchPositions.Create(3, 0d, 0d, Commands.ecs_commands.anti_fog_sw.ToString("d"), "Posn", "%0.3f"), "ECS", "Anti-Fog", "%0.3f"));
            #endregion ECS
            #region ENGINE
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "590", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.engctrl_commands.left_eng_ctrl_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.engctrl_commands.left_eng_ctrl_sw.ToString("d")) }, "ENGINE", "Left Engine Control Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "591", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.engctrl_commands.right_eng_ctrl_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.engctrl_commands.right_eng_ctrl_sw.ToString("d")) }, "ENGINE", "Right Engine Control Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "592", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.engctrl_commands.left_eng_master_cover.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.engctrl_commands.left_eng_master_cover.ToString("d")) }, "ENGINE", "Left Engine Master Switch Cover", "%0.1f"));
            AddFunction(new Switch(this, devices.DEEC.ToString("d"), "593", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.engctrl_commands.left_eng_master_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.engctrl_commands.left_eng_master_sw.ToString("d")) }, "ENGINE", "Left Engine Master Switch", "%0.1f"));
            ...
            AddFunction(new Switch(this, devices.EPSS.ToString("d"), "589", SwitchPositions.Create(3, 0d, 0d, Commands.engpnl_commands.generator_emerg_sw.ToString("d"), "Posn", "%0.3f"), "Generators", "Emergency Generator", "%0.3f"));
            ...
            #endregion ANTI ICE
            #region AIR COND
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "562", SwitchPositions.Create(3, 0d, 0d, Commands.aircoctrl_commands.airco_auto_man_off_sw.ToString("d"), "Posn", "%0.3f"), "AIR COND", "Air Conditiong Auto/Manual/Off", "%0.3f"));
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "563", SwitchPositions.Create(3, 0d, 0d, Commands.aircoctrl_commands.airco_max_norm_min_sw.ToString("d"), "Posn", "%0.3f"), "AIR COND", "Air Conditiong Max/Norm/Min", "%0.3f"));
            AddFunction(new Axis(this, devices.ECS.ToString("d"), Commands.aircoctrl_commands.airco_cold_hot_knob.ToString("d"), "564", 0.1d, 0.0d, 1.0d, "AIR COND", "Air Conditiong Cold/Hot", false, "%0.1f"));
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "565", SwitchPositions.Create(4, 0d, 0d, Commands.aircoctrl_commands.airco_eng_knob.ToString("d"), "Posn", "%0.3f"), "AIR COND", "Air Conditioning Source", "%0.3f"));
            #endregion AIR COND
            #region INT LT
            ...
            //AddFunction(new PushButton(this, devices.INTLT.ToString("d"), "573", "intlt_commands.wac_bklt_knob_reset", "INT LT", "Button Warning/Caution Lights (RMB to RESET when BRT)", "%1d"));
            AddFunction(new Axis(this, devices.INTLT.ToString("d"), Commands.intlt_commands.wac_bklt_knob.ToString("d"), "573", 0.5d, 0.0d, 1.0d, "INT LT", "Knob Warning/Caution Lights (RMB to RESET when BRT)", false, "%0.1f"));
            ...
            #endregion INT LT
            #region CANOPY
            AddFunction(new Switch(this, devices.CNPYSYST.ToString("d"), "599", SwitchPositions.Create(4, 0d, 0d, Commands.cnp_commands.cnpy_lever.ToString("d"), "Posn", "%0.3f"), "CANOPY", "Canopy Handle", "%0.3f"));
            AddFunction(new Switch(this, devices.CNPYSYST.ToString("d"), "1479", SwitchPositions.Create(4, 0d, 0d, Commands.cnp_commands.rear_cnpy_lever.ToString("d"), "Posn", "%0.3f"), "CANOPY", "Canopy Handle Rear", "%0.3f"));
            ...
            AddFunction(new PushButton(this, devices.FLINST.ToString("d"), Commands.fltinst_commands.rc_art_hor_adj.ToString("d"), "1355", "Flight Instruments (WSO)", "Button Backup ADI Cage/Pitch Adjust Knob - Pull and turn to uncage", "%1d"));
            ...
            AddFunction(new Switch(this, devices.CNPYSYST.ToString("d"), "1386", SwitchPositions.Create(3, 0d, 0d, Commands.cnp_commands.eject_select_valve.ToString("d"), "Posn", "%0.3f"), "Emergency Jettison and Misc Handles (WSO)", "Eject Selector Handle", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.TGPCTRL.ToString("d"), "1413", SwitchPositions.Create(3, 0d, 0d, Commands.snsrctrl_commands.tpod_pwr_sw.ToString("d"), new string[] { "OFF", "STBY", "ON" }, "%0.3f"), "TPOD Panel (WSO)", "TGP Power Switch OFF/STBY/ON", "%0.3f"));
            ...
            AddFunction(new Switch(this, devices.EWS_JMR.ToString("d"), "1419", SwitchPositions.Create(3, 0d, 0d, Commands.tews_commands.ics_mode_sw.ToString("d"), new string[] { "STBY", "AUTO", "MAN" }, "%0.3f"), "EW Panel (WSO)", "ICS Operational Mode Switch STBY/AUTO/MAN", "%0.3f"));
            #endregion EW Panel (WSO)
            #region VOL (WSO)
            AddFunction(new Axis(this, devices.TEWS.ToString("d"), Commands.volctrl_commands.rc_caution_vol.ToString("d"), "1420", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "Caution Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.TEWS.ToString("d"), Commands.volctrl_commands.rc_launch_vol.ToString("d"), "1421", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "Launch Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.EWS_JMR.ToString("d"), Commands.volctrl_commands.rc_ics_vol.ToString("d"), "1422", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "ICS Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.PACS.ToString("d"), Commands.volctrl_commands.rc_wpn_vol.ToString("d"), "1423", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "WPN Voume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.ILS.ToString("d"), Commands.volctrl_commands.rc_ils_vol.ToString("d"), "1424", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "ILS Volume", false, "%0.1f"));
            AddFunction(new Axis(this, devices.TACAN.ToString("d"), Commands.volctrl_commands.rc_tacan_vol.ToString("d"), "1425", 0.1d, 0.0d, 1.0d, "VOL (WSO)", "TACAN Volume", false, "%0.1f"));
            #endregion VOL (WSO)
            #region MICS (WSO)
            ...
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "1427", SwitchPositions.Create(3, 0d, 0d, Commands.micsctrl_commands.rc_mic_sw.ToString("d"), "Posn", "%0.3f"), "MICS (WSO)", "MIC Switch", "%0.3f"));
            ...
            #endregion MICS (WSO)
            #region RADIO (WSO)
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "1429", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.radioctrl_commands.rc_tone_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.radioctrl_commands.rc_tone_sw.ToString("d")) }, "RADIO (WSO)", "Tone Switch", "%0.1f"));
            AddFunction(new Switch(this, devices.FLINST.ToString("d"), "1430", new SwitchPosition[] { new SwitchPosition("1.0", "Posn 1", Commands.radioctrl_commands.rc_cypher_txt_sw.ToString("d")), new SwitchPosition("0.0", "Posn 2", Commands.radioctrl_commands.rc_cypher_txt_sw.ToString("d")) }, "RADIO (WSO)", "Cypher Text Switch", "%0.1f"));
            #endregion RADIO (WSO)
            ...
            #region OXYGEN Control Panel (WSO)
            ...
            AddFunction(new Switch(this, devices.ECS.ToString("d"), "1452", SwitchPositions.Create(3, 0d, 0d, Commands.oxyctrl_commands.wso_oxy_pbg_on_off_sw.ToString("d"), "Posn", "%0.3f"), "OXYGEN Control Panel (WSO)", "Oxygen Supply/Mode Control Switch", "%0.3f"));
            ...
            //AddFunction(new PushButton(this, devices.INTLT.ToString("d"), "1463", "intlt_commands.rc_wac_bklt_knob_reset", "INT LT Control Panel (WSO)", "Button Warning/Caution Lights (RMB to RESET when BRT)", "%1d"));
            AddFunction(new Axis(this, devices.INTLT.ToString("d"), Commands.intlt_commands.rc_wac_bklt_knob.ToString("d"), "1463", 0.5d, 0.0d, 1.0d, "INT LT Control Panel (WSO)", "Knob Warning/Caution Lights (RMB to RESET when BRT)", false, "%0.1f"));
            AddFunction(new Axis(this, devices.INTLT.ToString("d"), Commands.intlt_commands.rc_flood_lt_knob.ToString("d"), "1464", 0.1d, 0.0d, 1.0d, "INT LT Control Panel (WSO)", "Storm FLood Lights", false, "%0.1f"));
            AddFunction(new Axis(this, devices.INTLT.ToString("d"), Commands.intlt_commands.rc_chart_lt_lamp.ToString("d"), "188", 0.1d, 0.0d, 1.0d, "INT LT Control Panel (WSO)", "Chart Light", false, "%0.1f"));
            #endregion INT LT Control Panel (WSO)
            ...
            AddFunction(new Switch(this, devices.EWS_CMD.ToString("d"), "1475", SwitchPositions.Create(3, 0d, 0d, Commands.tews_commands.cmd_disp_sel_sw.ToString("d"), new string[] { "FLARE", "BOTH", "CHAFF" }, "%0.3f"), "CMD Control Panel (WSO)", "CMD Dispenser Selection Switch FLARE/BOTH/CHAFF", "%0.3f"));
            AddFunction(new Switch(this, devices.EWS_CMD.ToString("d"), "1476", SwitchPositions.Create(5, 0d, 0d, Commands.tews_commands.cmd_mode_knob.ToString("d"), new string[] { "OFF", "STBY", "MAN", "SEMI", "AUTO" }, "%0.3f"), "CMD Control Panel (WSO)", "CMD Operational Mode OFF/STBY/MAN/SEMI/AUTO", "%0.3f"));
