# **Helios Virtual Cockpit 1.6 Plugin: DCS Mirage F1**

This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the DCS Mirage F1 from Aerges Engineering.  
