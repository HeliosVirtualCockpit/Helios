# **Helios Virtual Cockpit 1.6 Plugin: DCS Ka-50 Blackshark**
   
This is a plugin component for Helios Virtual Cockpit 1.6 which provides an interface and controls for the Ka-50 Blackshark from Eagle Dynamics.  
